...
Decidim::Admin::Engine.routes.draw do
  constraints(->(request) { Decidim::Admin::OrganizationDashboardConstraint.new(request).matches? }) do
    ...
    resources :officializations, only: [:new, :create, :index, :destroy, :richiesta], param: :user_id
    get 'officializations/richiesta' => 'officializations#richiesta'
    get 'officializations/richiesta/delete' => 'officializations#cancella'
